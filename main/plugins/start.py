...
S = "/start"
START_PIC = "https://telegra.ph/file/0eca3245df8a40c7e68d4.jpg"
TEXT = "❣️**Hi, I'm Restricted Content Saver Bot** 🔰\n😎 **Send me the Link 🔗 of any message of Restricted Channels to Clone it here(⁠*⁠_⁠*⁠)**\n\n**------------------------------------------------------**\n🔴 Bot Made by ~ `@NtrRazYt`\n🔴 Official Channel ~ `@ClassTubeOfficial`\n🔴 Other Bot ~ `@MasterTxtUploaderbot`\n**------------------------------------------------------**"
...
async def start_command(event):
    ...
    buttons = [
        ...
        [Button.url("Join Channel", url="https://telegram.dog/ClassTubeOfficial")]
    ]
